...
{
    [DisplayName("Push Universal Package (Deprecated)")]
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            var client = new ObsoleteProGetClient(this.Server, this.FeedName, this.UserName, this.Password, this, context.CancellationToken);
            ...
            try
            {
                ...
                var data = new ObsoleteProGetClient.ProGetPackagePushData
                {
                    Title = this.Title,
